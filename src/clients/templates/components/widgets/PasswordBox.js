      ...
      <div >
        ...
        <div style = {{marginBottom: '42px'}}>
          <div className="w3-cell-row">
            ...
            <label className="w3-text-orange "><a target={this.props.hrefTarget || '_self'} href={`${this.props.urlBasePath}/form?name=requestresetpassword&realm=${this.props.realm}&app=${this.props.app}&email=${this.props.email}`}> Forgot your password </a></label>
            </div>
